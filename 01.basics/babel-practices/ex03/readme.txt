...
라이브러리 설치
$ npm i -D @babel/core @babel/cli      // (@ : namespace)

플러그인 적용
1. 블록 스코프 변수 플로그인 (@babel/plugin-transform-block-scoping)
$ npm i -D @babel/plugin-transform-block-scoping
$ npx babel src/ex.js -o dist/ex.js --plugins @babel/plugin-transform-block-scoping  // 개별적으로 적용 가능
